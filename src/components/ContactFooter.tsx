...
export const ContactFooter = () => {
  ...
  return (
    <section id="contact" className="bg-page px-4 py-10 md:px-8 md:py-16">
      <div className="mx-auto max-w-[1400px] overflow-hidden rounded-[28px] bg-dark text-dark-foreground">
        ...
        <div className="flex flex-col gap-4 border-t border-dark-border px-6 py-6 md:flex-row md:items-center md:justify-between md:px-10">
          <ul className="flex flex-wrap gap-x-8 gap-y-2 text-[15px] text-white">
            <li><a href="/" className="hover:text-dark-muted">Homepage</a></li>
            <li><a href="/what-we-do" className="hover:text-dark-muted">Services</a></li>
            <li><a href="/about-us" className="hover:text-dark-muted">About us</a></li>
            <li><a href="/contact" className="hover:text-dark-muted">Contact</a></li>
          </ul>
          <ul className="flex gap-8 text-[15px] text-white">
            <li><a href="#" className="hover:text-dark-muted">Privacy Made</a></li>
            <li><a href="#" className="hover:text-dark-muted">Terms</a></li>
          </ul>
        </div>
      </div>
    </section>
