    ...
    <section className="bg-page px-4 py-10 md:px-8 md:py-16">
      <Reveal>
        <div className="relative mx-auto max-w-[1400px] overflow-hidden rounded-[28px] group">
          <img src={bg} alt="" loading="lazy" width={1920} height={768} className="image-zoom absolute inset-0 h-full w-full object-cover" />
          ...
          <div className="relative grid gap-12 p-10 md:grid-cols-2 md:p-16">
            ...
            <div className="flex flex-col gap-8 text-white">
              ...
              <div className="flex items-center gap-4">
                <img src={avatar} alt="Naledi Mokoena" loading="lazy" width={56} height={56} className="h-14 w-14 rounded-full object-cover ring-2 ring-white/30" />
                <div>
